...
export class PublisherModificationView extends React.Component<Props, State> {
    ...
    componentDidMount() {
        Groups.get().then((g) => this.setState({ groups: g }), (err) => console.error(err));
    }
        ...
        return (
            <Form style={{width: '100%'}}>
                <Form.Group className="mb-3">
                    ...
                    <Button appearance="subtle" onClick={() => this.props.onHide()}>Retour</Button>
                    <Button appearance="primary" onClick={() => this.savePublisher()}>Enregistrer</Button>
                </Form.Group>
                {error && <Banner
                    appearance="warning"
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="text" placeholder="Patrick" value={publisher.firstName} onChange={(e) => {
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="text" placeholder="Irenge" value={publisher.name} onChange={(e) => {
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="text" placeholder="Kiyuka" value={publisher.lastName} onChange={(e) => {
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="date" value={birthDateValue} onChange={(e) => {
                        publisher.birthDate = Timestamp.fromDate(new Date(e.target.value));
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="date" value={baptismDateValue} onChange={(e) => {
                        publisher.baptismDate = Timestamp.fromDate(new Date(e.target.value));
                ...
                <   Form.Label>Groupe de prédication</Form.Label>
                    ...
                    >
                        { groups.map((group, index) => <Dropdown.Item key={index} eventKey={index}> {group.name}</Dropdown.Item>) }
                    </DropdownButton>
                </Form.Group>
            </Form>
        );
