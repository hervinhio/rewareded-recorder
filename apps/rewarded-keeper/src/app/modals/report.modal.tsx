...
export function RepportModal(props: Props) {
    const defaultMonth = props.repport ? Month.fromKey(props.repport.monthId) : undefined;
    const [ error, setError ] = useState('');
    const [ publications, setPublications ] = useState(props.repport?.publications || 0);
    ...
    return (
        <Modal>
            {shouldShowModal && <ModalTransition>
                <ModalHeader><ModalTitle>Enregistrer un rapport</ModalTitle></ModalHeader>
                <ModalBody>
                    <Form>
                        {error && <Banner
                            appearance="warning"
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <MonthSelector selectedMonth={month} onMonthSelected={(month: Month | undefined) => {
                                setMonth(month);
                            }}/>
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control value={props.repport?.publications} type="number" placeholder="0" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control value={props.repport?.videos} type="number" placeholder="0" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="number" value={props.repport?.hours} placeholder="0" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="number" value={props.repport?.visits} placeholder="0" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="number" value={props.repport?.courses} placeholder="0" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control as="textarea" value={props.repport?.comment} rows={3} onChange={(e) => {
...
const allParamsSet = (params: any) => {
    const requiredParams = ['publications', 'videos', 'hours', 'visits', 'courses'];
    return requiredParams.every((param: string) => params[param] !== null && params[param] !== undefined);
};
