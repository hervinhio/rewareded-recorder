...
export function CreatePublisherModal(props: Props) {
    ...
    useEffect(() => {
        Groups.get().then((groups) => setGroups(groups), (error: FirebaseError) => {
            console.error(error);
    ...
    return (
        <Modal>
            {props.show && <ModalTransition>
                <ModalHeader><ModalTitle>Créer un proclamateur</ModalTitle></ModalHeader>
                <ModalBody>
                    <Form>
                        {error && <Banner
                            appearance="warning"
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="text" placeholder="Patrick" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="text" placeholder="Irenge" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="text" placeholder="Kiyuka" onChange={(e) => {
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="date" placeholder="Kiyuka" onChange={(e) => {
                        ...
                        <Form.Label>Group</Form.Label>
                            <DropdownButton
                                ...
                                onSelect={(v) => v ? setGroupId(groups[Number(v)].id) : null}
                            >
...
const onValidate = (params: ValidationParams) => {
    if (!!params.name && !! params.firstName && !!params.baptismDate && !!params.birthDate) {
      Publishers.create({
