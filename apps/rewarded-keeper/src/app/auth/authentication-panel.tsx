  ...
  return (
    <div className="login-box">
        ...
        <div className="buttons">
          <SignInButton text="Se connecter avec Google" onClick={() => authenticate()}/>
          <div className="hr"></div>
          <span className="register-hint">Pas de compte ? <a href="#" onClick={() => authenticate(true)}>Enregistrez-vous</a></span>
        </div>
    </div>
  );
}
...
const getText = (status: AuthStatus) => {
  if (status.unexisting) {
    ...
    return <span>Veuille contacter votre administrateur afin qu'il valide votre compte.</span>
  } else {
